...
public class AdminBasicInfoController {
    private final static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(AdminBasicInfoController.class);
    ...
    public GetAllContactsResult getAllContacts(@PathVariable String id){
        logger.info("[Admin Basic Info Service][Find All Contacts by admin: " + id);
    ...
    public DeleteContactsResult deleteContacts(@RequestBody DeleteContactsInfo dci){
        logger.info("[Admin Basic Info Service][Delete Contacts by admin: " + dci.getLoginId());
    ...
    public ModifyContactsResult modifyContacts(@RequestBody ModifyContactsInfo mci){
        logger.info("[Admin Basic Info Service][Modify Contacts by admin: " + mci.getLoginId());
    ...
    public AddContactsResult addContacts(@RequestBody Contacts c){
        logger.info("[Admin Basic Info Service][Modify Contacts by admin: " + c.getLoginId());
    ...
    public GetAllStationResult getAllStations(@PathVariable String id){
        logger.info("[Admin Basic Info Service][Find All Station by admin: " + id);
    ...
    public boolean deleteStation(@RequestBody Station s){
        logger.info("[Admin Basic Info Service][Delete Station by admin: " + s.getLoginId());
    ...
    public boolean modifyStation(@RequestBody Station s){
        logger.info("[Admin Basic Info Service][Modify Station by admin: " + s.getLoginId());
    ...
    public GetAllTrainResult getAllTrains(@PathVariable String id){
        logger.info("[Admin Basic Info Service][Find All Train by admin: " + id);
    ...
    public boolean deleteTrain(@RequestBody TrainInfo2 t){
        logger.info("[Admin Basic Info Service][Delete Train by admin: " + t.getLoginId());
    ...
    public boolean modifyTrain(@RequestBody TrainType t){
        logger.info("[Admin Basic Info Service][Modify Train by admin: " + t.getLoginId());
    ...
    public GetAllConfigResult getAllConfigs(@PathVariable String id){
        logger.info("[Admin Basic Info Service][Find All Config by admin: " + id);
    ...
    public String deleteConfig(@RequestBody ConfigInfo2 c){
        logger.info("[Admin Basic Info Service][Delete Config by admin: " + c.getLoginId());
    ...
    public String modifyConfig(@RequestBody Config c){
        logger.info("[Admin Basic Info Service][Modify Config by admin: " + c.getLoginId());
    ...
    public GetAllPriceResult getAllPrices(@PathVariable String id){
        logger.info("[Admin Basic Info Service][Find All Price by admin: " + id);
    ...
    public boolean deletePrice(@RequestBody PriceInfo pi){
        logger.info("[Admin Basic Info Service][Delete Price by admin: " + pi.getLoginId());
    ...
    public boolean modifyPrice(@RequestBody PriceInfo pi){
        logger.info("[Admin Basic Info Service][Modify Price by admin: " + pi.getLoginId());
    ...
    public ReturnSinglePriceConfigResult addPrice(@RequestBody PriceInfo pi){
        logger.info("[Admin Basic Info Service][Add Price by admin: " + pi.getLoginId());
