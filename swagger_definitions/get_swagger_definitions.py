...
available_versions = ["master", "error-f1", "error-f2", "error-f3", "error-f4", "error-f5", "error-f6", "error-f7", "error-f8"]

version_groups = {"master_grp": ["master"],
                  "error_grp": ["error-f4", "error-f1", "error-f3", "error-f6", "error-f8"],
...
if __name__ == '__main__':
    ...
    if not version_argument:
        print("No version selected defaulting to version \"error-f8\"", file=sys.stderr)
        version_argument = "error-f8"
    else:
