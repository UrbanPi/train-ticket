...
available_versions = ["master", "error-f4", "error-f1",  "error-f2", "error-f3",  "error-f5"]

version_groups = {"master_grp": ["master"], "error_grp": ["error-f4", "error-f1", "error-f3"], "error_grp_2": ["error-f2", "error-f5"]}
