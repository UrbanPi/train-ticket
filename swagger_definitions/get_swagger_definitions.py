...
available_versions = ["master", "error-f4", "error-f1",  "error-f2", "error-f3"]

version_groups = {"master_grp": ["master"], "error_grp": ["error-f4", "error-f1", "error-f3"], "error_grp_2": ["error-f2"]}
...
if __name__ == '__main__':
    ...
    if not version_argument:
        print("No version selected defaulting to version \"error-f3\"", file=sys.stderr)
        version_argument = "error-f3"
    else:
