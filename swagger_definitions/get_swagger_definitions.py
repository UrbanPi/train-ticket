...
available_versions = ["master", "error-f1", "error-f2", "error-f3", "error-f4", "error-f5", "error-f6", "error-f7", "error-f8", "error-f10", "error-f11"]
...
if __name__ == '__main__':
    ...
    if not version_argument:
        print("No version selected defaulting to version \"error-f11\"", file=sys.stderr)
        version_argument = "error-f11"
    else:
