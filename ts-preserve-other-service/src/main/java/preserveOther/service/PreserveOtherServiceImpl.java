    ...
    public OrderTicketsResult preserve(OrderTicketsInfoWithOrderId oti,String accountId,String loginToken){
        ...
        if(tokenResult.isStatus() == true){
            ...
            if(gtdr.isStatus() == false){
                logger.info("[Preserve Other Service][Search For Trip Detail Information] " + gcr.getMessage());
                otr.setStatus(false);
                otr.setMessage(gcr.getMessage());
                otr.setOrder(null);
                return otr;
                ...
                if(oti.getSeatType() == SeatClass.FIRSTCLASS.getCode()){
                    if(tripResponse.getConfortClass() == 0){
                        logger.info("[Preserve Other Service][Check seat is enough] " + gcr.getMessage());
                        otr.setStatus(false);
            ...
            // Fall back to generating a random orderId when none is provided
            if (oti.getOrderId() == null) {
