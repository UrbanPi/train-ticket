...
//        }
    ...
    @Test (dependsOnMethods = {"testSelectContacts_One"})
    public void testTicketConfirm_One ()throws Exception{
    ...
    @Test (dependsOnMethods = {"testTicketConfirm_One"})
    public void testSelectContacts_Two()throws Exception{
        driver.findElement(By.id("ticket_confirm_cancel_btn")).click();
        Thread.sleep(1000);
        driver.findElement(By.id("refresh_booking_contacts_button")).click();
        Thread.sleep(2000);
        ...
        if (contactsList.size() >= 1){
            ...
            String idNumber = "1234567890";
            String phoneNumber = getRandomString(11);
            //int localINdex = contactsList.size() - 1;
            contactsList.get(1).findElement(By.xpath("td[2]/input")).sendKeys(contactName);

            WebElement elementContactstype = contactsList.get(1).findElement(By.xpath("td[3]/select"));
            Select selTraintype = new Select(elementContactstype);
            selTraintype.selectByValue(documentType); //ID type

            contactsList.get(1).findElement(By.xpath("td[4]/input")).sendKeys(idNumber);
            contactsList.get(1).findElement(By.xpath("td[5]/input")).sendKeys(phoneNumber);
            contactsList.get(1).findElement(By.xpath("td[6]/label/input")).click();
        }
...
//        }
    ...
    @Test (dependsOnMethods = {"testSelectContacts_Two"})
    public void testTicketConfirm_Two ()throws Exception{
        String itemFrom = driver.findElement(By.id("ticket_confirm_from")).getText();
        String itemTo = driver.findElement(By.id("ticket_confirm_to")).getText();
        String itemTripId = driver.findElement(By.id("ticket_confirm_tripId")).getText();
        String itemPrice = driver.findElement(By.id("ticket_confirm_price")).getText();
        ...
        String statusAlert = driver.switchTo().alert().getText();
        logger.info("The Alert information of Confirming Ticket："+statusAlert);
        Assert.assertEquals(statusAlert.startsWith("Something Wrong"),true);
        javascriptConfirm.accept();
    }
    @Test (dependsOnMethods = {"testTicketConfirm_Two"})
    public void testSelectContacts_Three()throws Exception{
        driver.findElement(By.id("ticket_confirm_cancel_btn")).click();
        Thread.sleep(1000);
        driver.findElement(By.id("refresh_booking_contacts_button")).click();
        Thread.sleep(2000);
        ...
        if (contactsList.size() >= 1){
            ...
            String phoneNumber = getRandomString(11);
            //int localINdex = contactsList.size() - 1;
            contactsList.get(2).findElement(By.xpath("td[2]/input")).sendKeys(contactName);

            WebElement elementContactstype = contactsList.get(2).findElement(By.xpath("td[3]/select"));
            Select selTraintype = new Select(elementContactstype);
            selTraintype.selectByValue(documentType); //ID type

            contactsList.get(2).findElement(By.xpath("td[4]/input")).sendKeys(idNumber);
            contactsList.get(2).findElement(By.xpath("td[5]/input")).sendKeys(phoneNumber);
            contactsList.get(2).findElement(By.xpath("td[6]/label/input")).click();
        }
...
//        }
    ...
    @Test (dependsOnMethods = {"testSelectContacts_Three"})
    public void testTicketConfirm_Three ()throws Exception{
        String itemFrom = driver.findElement(By.id("ticket_confirm_from")).getText();
        String itemTo = driver.findElement(By.id("ticket_confirm_to")).getText();
        String itemTripId = driver.findElement(By.id("ticket_confirm_tripId")).getText();
        String itemPrice = driver.findElement(By.id("ticket_confirm_price")).getText();
...
//            logger.info("Ticket payment failed!");
...
//            logger.info("Failed to Collect Ticket! Status is Null!");
//        else if(statusCollectOrderId.startsWith("Success"))
//            logger.info("Success to Collect Ticket! Status:"+statusCollectOrderId);
//        else
//            logger.info("Failed to Collect Ticket! Status is:"+statusCollectOrderId);
...
//            logger.info("Enter Station,No Order Id,failed");
...
//            logger.info("Failed to Enter Station! Status is Null!");
//        else if(statusEnterStation.startsWith("Success"))
//            logger.info("Success to Enter Station! Status:"+statusEnterStation);
//        else
//            logger.info("Failed to Enter Station! Status is:"+statusEnterStation);
